...
//     try
//     {
//         let data=await Application.find({"jobId":req.params.id},{"jobseekerId":1})
        
//         let arr=[];
//         data.forEach((obj)=>{
//             arr.push({"_id": obj.jobseekerId});
//         })

//         let jbs=await Jobseeker.find({"$or":arr},{"profileimage":0});

//         res.json({success:true,data:jbs})
